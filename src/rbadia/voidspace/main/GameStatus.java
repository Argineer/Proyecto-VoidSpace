...
public class GameStatus {
	...
	private boolean gameOnNextLevel = false;
	...
	/**
	 * Indicates if the game is on the next level ("Level 1 Passed!" message is displaying) or not.
	 * @return if the game is starting or not.
	 */
	public synchronized boolean isGameOnNextLevel() {
		return gameOnNextLevel;
	}
	
	public synchronized void setGameOnNextLevel(boolean gameOnNextLevel) {
		this.gameOnNextLevel = gameOnNextLevel;
	}
	...
	/**
	 * Indicates if a new second asteroid should be created/drawn.
	 * @return if a new second asteroid should be created/drawn
	 */
